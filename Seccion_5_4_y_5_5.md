...
El escenario esperado constituye la proyección central del proyecto y refleja las condiciones operativas más probables conforme a la calibración de mercado descrita en la sección 5.4. Bajo este escenario, FinPet alcanza 3,316 suscriptores al mes 24 y 4,423 al mes 36, ubicándose dentro del 98% de la meta declarada de 4,500. El primer resultado mensual positivo se registra en el mes 13, coincidiendo con la transición al segundo año operativo, y la recuperación de la inversión inicial ocurre en el mes 40, ocho meses antes que en el escenario pesimista. Al cierre del horizonte de proyección, el resultado acumulado asciende a $2,636,375.18 MXN, lo que equivale a una ganancia neta acumulada cercana al 64% sobre la inversión inicial de $4,128,192 MXN.

La trayectoria operativa muestra que el modelo transita por tres fases claramente diferenciadas. La primera fase, comprendida entre los meses 1 y 12, corresponde al periodo de absorción de la inversión inicial y se caracteriza por resultados mensuales negativos que se moderan progresivamente. La segunda fase, entre los meses 13 y 39, exhibe resultados mensuales positivos pero un resultado acumulado todavía deficitario, durante la cual el proyecto opera con autosuficiencia operativa pero aún no ha amortizado el capital invertido. La tercera fase, a partir del mes 40, corresponde al régimen de rentabilidad neta, donde tanto el flujo mensual como el resultado acumulado son positivos. Al mes 48 el ingreso total mensual alcanza $642,936.58 MXN y el resultado mensual del periodo se sitúa en $363,567.27 MXN, equivalente a un margen operativo del 57%.

El portafolio de crédito acumula un total de 742-802 créditos otorgados a lo largo de los cuatro años, con una cartera viva al mes 48 de aproximadamente $4.56 millones MXN. El porcentaje de suscriptores con crédito abierto se estabiliza alrededor del 7%-9% de la base, comportamiento consistente con la tasa de incidencia de emergencias del 25% anual estimada en la sección 3.4 y con la lógica de que no todos los suscriptores con derecho a línea de crédito ejercerán esa opción en un mes dado.

### 5.5.4 Escenario optimista

El escenario optimista contempla la combinación más favorable de parámetros operativos: tasa de interés del 48% anual, MDR del 3%, costo de fondeo del 15%, LGD del 60% y churn del 2%. Bajo estas condiciones, FinPet alcanza 3,546 suscriptores al mes 24 y 4,660 al mes 36, superando ligeramente la meta declarada antes de tiempo. El primer resultado mensual positivo se adelanta al mes 12, un mes antes que en los otros dos escenarios, gracias a la combinación de mayor tasa de interés y menor LGD que incrementa el margen unitario por crédito desde las primeras disposiciones.

Sin embargo, este escenario presenta una particularidad relevante: a pesar de que el flujo operativo es superior al del escenario esperado, la inversión inicial también es más elevada ($4,816,224 MXN frente a $4,128,192 MXN), de modo que la recuperación de la inversión inicial se materializa también en el mes 40, mismo mes que en el escenario esperado. Esto evidencia que la mayor agresividad de la inversión inicial compensa el flujo operativo más rápido, y que el indicador de tiempo de recuperación no es monotónico respecto al optimismo operativo. No obstante, al cierre del horizonte de proyección el resultado acumulado del escenario optimista asciende a $3,319,049.13 MXN, superior al esperado en aproximadamente $683,000 MXN, lo que confirma la mayor rentabilidad terminal del escenario aun a costa de una recuperación equivalente en términos temporales.

El volumen de originación crediticia en este escenario es sustancialmente mayor: el portafolio acumula entre 1,005 y 1,008 créditos otorgados durante los cuatro años, con una cartera viva al mes 48 cercana a $5.98 millones MXN. El ingreso total mensual al mes 48 alcanza $730,583.79 MXN y el resultado mensual del periodo se sitúa en $418,858.31 MXN, equivalente a un margen operativo del 57%, similar al del escenario esperado en términos porcentuales pero superior en términos absolutos por el mayor volumen de operación.
...
| Mes con primer resultado mensual positivo | 13 | 13 | 12 |
| Mes de recuperación de la inversión inicial | 48 | 40 | 40 |
| Resultado acumulado al mes 24 (MXN) | -3,726,576 | -3,762,369 | -3,975,233 |
| Resultado acumulado al mes 36 (MXN) | -2,167,816 | -1,134,636 | -931,858 |
| Resultado acumulado al mes 48 (MXN) | 52,965 | 2,636,375 | 3,319,049 |
| Ingreso total mes 48 (MXN) | 425,015 | 642,937 | 730,584 |
| Resultado mensual al mes 48 (MXN) | 210,022 | 363,567 | 418,858 |
| Créditos totales originados (48 meses) | 527 | 742-802 | 1,005-1,008 |

Tabla 17. Síntesis comparativa de los resultados de proyección por escenario. Elaboración propia.

La lectura conjunta de los tres escenarios permite extraer tres conclusiones operativas. Primero, el modelo es robusto frente a la adversidad: incluso en el escenario pesimista, donde se combinan simultáneamente todas las desviaciones desfavorables de los parámetros, el proyecto logra recuperar la inversión inicial dentro del horizonte de proyección, sin necesidad de capital adicional. Segundo, el momento de inflexión operativa, definido como el primer resultado mensual positivo, se concentra entre los meses 12 y 13 en los tres escenarios, lo que evidencia que la sostenibilidad operativa mensual depende principalmente de la consolidación de la base de suscriptores y de la entrada al segundo año con costos fijos reducidos, más que de la calibración fina de los parámetros de riesgo o de tasa. Tercero, el indicador de tiempo de recuperación de la inversión es sensible no solo al desempeño operativo sino también al tamaño de la inversión inicial, lo que invita a evaluar cuidadosamente la decisión de capitalización: una mayor capitalización inicial habilita mayor originación pero extiende temporalmente el periodo de amortización.
